...
export function PropertyCard({ property, favorite = false}: PropertyCardProps) {
    ...
    { /* TODO Action du bouton (Ajout aux favoris/suppression des favoris) */}
    ...
    return (
        <div className={"relative w-fit"}>
            ...
            <button
                type="button"
                className={`absolute right-4 top-4 flex h-8 w-8 items-center justify-center rounded-[5px] ${isFavorite ? "bg-mainRed" : "bg-lightGrey"}`}
